 ...
 * ActionDefaultOld
 *
 * @ORM\Table(name="action_default_old", uniqueConstraints={@ORM\UniqueConstraint(name="_key", columns={"workflow_id", "owner_id", "position", "sort"})}, indexes={@ORM\Index(name="action_owner", columns={"owner_id"}), @ORM\Index(name="action_pos", columns={"position"}), @ORM\Index(name="action_status", columns={"is_enabled"})})
 * @ORM\Entity
 */
class ActionDefaultOld
{
    /**
     * @var integer
     *
