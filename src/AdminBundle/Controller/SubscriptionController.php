...
class SubscriptionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render(
            'subscription/index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AdminBundle\Form\SubscriptionType', $subscription);
    ...
    {
        $deleteForm = $this->createDeleteForm($subscription);
        $editForm = $this->createForm('AdminBundle\Form\SubscriptionType', $subscription);
