...
class NoteController extends Controller
{
    ...
    {
        $note = new Note();
        $form = $this->createForm('AdminBundle\Form\NoteType', $note);
    ...
    {
        $deleteForm = $this->createDeleteForm($note);
        $editForm = $this->createForm('AdminBundle\Form\NoteType', $note);
